...
class EncoderRNN(nn.Module):
    def __init__(self, vocab_size, embed_size, hidden_size, num_layers, num_direction, rnn_type='GRU', embedding_weight=None, dropout_rate=0.1):
    ...
    def forward(self, x, hidden, lengths, cell=None):
        ...
        # else:
        #     pass
        return rnn_out, hidden, cell #(bz, src_len, num_direction*hidden_size) (num_layers*num_direction, bz, hidden_size) (num_layers*num_direction, bz, hidden_size)
